...
// License GNU - GPL3
	function affichersurate(numerosurate){
				...
				$.ajax({
					url : "https://api.ascmv.net/hadith/api/mode/UTH-FULLCHAPTER/surat/"+numerosurateentier+"/callback/?",
					dataType:"jsonp",
					jsonp:"callback",
